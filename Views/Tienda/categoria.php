					...
					<div class="block2">
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							<div class="block2-txt-child1 flex-col-l ">
								<a href="<?= base_url().'/tienda/producto/'.$arrProductos[$p]['Prod_ID'].'/'.$ruta; ?>" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
							...
							<div class="block2-txt-child2 flex-r p-t-3">
								<a href="<?= base_url().'/tienda/producto/'.$arrProductos[$p]['Prod_Nombre']; ?>" class="btn-addwish-b2 dis-block pos-relative js-addwish-b2">
