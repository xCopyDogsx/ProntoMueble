	...
	<section class="bg0 p-t-23 p-b-140">
		<div class="container">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							...
							<a href="<?= base_url().'/tienda/producto/'.$arrProductos[$p]['Prod_ID'].'/'.$rutaProducto; ?>" class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04">
								Ver producto
							</a>
						</div>
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							<div class="block2-txt-child1 flex-col-l ">
								<a href="<?= base_url().'/tienda/producto/'.$arrProductos[$p]['Prod_ID'].'/'.$rutaProducto; ?>" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
									<?= $arrProductos[$p]['Prod_Nom'] ?>
								</a>
			...
			<div class="flex-c-m flex-w w-full p-t-45">
				<a href="<?= base_url();?>/tienda" class="flex-c-m stext-101 cl5 size-103 bg2 bor1 hov-btn1 p-lr-15 trans-04">Muestrame más
				</a>
			</div>
		</div>
	</section>
